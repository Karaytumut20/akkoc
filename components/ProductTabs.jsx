    ...
    <div className="mt-6 space-y-6 bg-gradient-to-br from-[#FFFFF0] to-[#f0fff0] rounded-xl border border-gray-100 p-6 shadow-sm">
      ...
      <div>
        ...
        <div className="flex flex-wrap items-center gap-3 text-sm text-gray-700">
          <span className="px-3 py-1 bg-[#fbe9e0] text-[#be531c] rounded-full font-medium">
            <strong>Kategori:</strong> {product.categories?.name || "Belirtilmemiş"}
          </span>
          <span className="px-3 py-1 bg-[#fbe9e0] text-[#be531c] rounded-full font-medium">
            <strong>Stok:</strong> {product.stock} adet
          </span>
          <span className="px-3 py-1 bg-[#fbe9e0] text-[#be531c] rounded-full font-medium">
            <strong>Kod:</strong> {product.id.substring(0, 8)}
          </span>
        </div>
      </div>
      */}
        ...
        <button
          ...
          className={`py-3 px-6 text-lg font-medium transition-colors duration-300 ${
            activeTab === 'description'
              ? 'border-b-2 border-[#be531c] text-[#be531c]'
