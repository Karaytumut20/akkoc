                ...
                <div className="p-6">
                    ...
                    <form onSubmit={onSubmitHandler} className="space-y-8">
                        ...
                        <FloatingLabelInput
                            ...
                            id="area"
                            name="area"
                            label="Address (Street, Neighborhood, Door No)"
                            value={address.area}
                            onChange={onChangeHandler}
                            required
                        />
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full mt-4 py-3 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition font-semibold disabled:bg-orange-400"
                        >
